...
exports.fetchFootballFixturesCron = new cron_1.CronJob("29 11 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    const footballEvents = yield (0, streams_1.fetchFootballHighlightEvents)();
    const events = yield footballEvents.reduce((all, current, index) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        console.log(`Starting ${index + 1} of ${footballEvents.length}`);
        ...
        total.push({ awayTeam: (_f = current.awayTeam.name) !== null && _f !== void 0 ? _f : "Away team", homeTeam: (_g = current.homeTeam.name) !== null && _g !== void 0 ? _g : "Home team", poster, id: current.id.toString(), league: (_j = (_h = current === null || current === void 0 ? void 0 : current.league) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : "League", name: `${(_k = current === null || current === void 0 ? void 0 : current.homeTeam) === null || _k === void 0 ? void 0 : _k.name} vs ${(_l = current === null || current === void 0 ? void 0 : current.awayTeam) === null || _l === void 0 ? void 0 : _l.name}`, time: dayjs_1.default.tz(current.date).utc(true).unix() });
        console.log(`Finished ${index + 1} of ${footballEvents.length}`);
        return total;
    }), Promise.resolve([]));
    yield (0, redis_1.saveToCache)('football-highlight-events', JSON.stringify(events), 26 * 60 * 60);
    console.log("fetched football higlight");
}));
const EventsApiCronWithCheckIn = Sentry.cron.instrumentCron(cron_1.CronJob, "fetchRapidFootballEvents");
exports.fetchRapidFootballEvents = new EventsApiCronWithCheckIn("30 14 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
