...
exports.fetchFootballFixturesCron = new cron_1.CronJob("00 05 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.fetchRapidFootballEvents = new EventsApiCronWithCheckIn("*/28 * * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (let index = 0; index < events.length; index++) {
            ...
            yield exports.prismaClient.rapidFootballCatalogue.upsert({
                where: {
                    eventId: a.id
                },
...
exports.fetchRapidEventsLink = new cron_1.CronJob("*/15 * * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield exports.prismaClient.$connect();
        ...
        for (let index = 0; index < missingLinks.length; index++) {
            const link = yield (0, streams_1.fetchRapidFootballeventLink)(missingLinks[index].eventId);
            if (link != null && link != "")
...
exports.FootballScheduleCronBuilder = new cron_1.CronJob("*/10 * * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const currentTime = (0, dayjs_1.default)().utc().unix();
        yield exports.prismaClient.$connect();
