    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const url = yield new Promise((resolve) => {
            try {
                ...
                stream.push(buffer);
                stream.push(null);
                const resulte = cloudinary_1.v2.uploader.upload_stream({ folder: "ppvstream-cricket" }, (err, resp) => {
                    var _a;
        ...
        try {
            ...
            const url = yield new Promise((resolve) => {
                try {
                    ...
                    stream.push(buffer);
                    stream.push(null);
                    const resulte = cloudinary_1.v2.uploader.upload_stream({ folder: "ppvstream-soccer" }, (err, resp) => {
                        var _a;
                        resolve((_a = resp === null || resp === void 0 ? void 0 : resp.secure_url) !== null && _a !== void 0 ? _a : "");
                    });
                    stream.pipe(resulte);
